...
* In the project directory open terminal (Command prompt for Windows).
...
* Open a web browser and navigate to Open [http://localhost:3000](http://localhost:3000) to view the project.
